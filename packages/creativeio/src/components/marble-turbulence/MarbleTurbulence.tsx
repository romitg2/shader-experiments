...
interface MarbleTurbulenceSceneProps {
  pointerRef: RefObject<PointerState>
}

function MarbleTurbulenceScene({ pointerRef }: MarbleTurbulenceSceneProps) {
...
export interface MarbleTurbulenceProps {
  className?: string
  style?: CSSProperties
}

export function MarbleTurbulence({ className, style }: MarbleTurbulenceProps) {
  ...
  return (
    ...
    >
      ...
      >
        <MarbleTurbulenceScene pointerRef={pointerRef} />
      </Canvas>
    </div>
  )
}

export default MarbleTurbulence
