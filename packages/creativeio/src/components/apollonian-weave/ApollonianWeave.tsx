...
interface ApollonianWeaveSceneProps {
  pointerRef: RefObject<PointerState>
}

function ApollonianWeaveScene({ pointerRef }: ApollonianWeaveSceneProps) {
...
export interface ApollonianWeaveProps {
  className?: string
  style?: CSSProperties
}

export function ApollonianWeave({ className, style }: ApollonianWeaveProps) {
  ...
  return (
    ...
    >
      ...
      >
        <ApollonianWeaveScene pointerRef={pointerRef} />
      </Canvas>
    </div>
  )
}

export default ApollonianWeave
