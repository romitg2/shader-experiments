...
interface FractalZoomSceneProps {
  pointerRef: RefObject<PointerState>
}

function FractalZoomScene({ pointerRef }: FractalZoomSceneProps) {
...
export interface FractalZoomProps {
  className?: string
  style?: CSSProperties
}

export function FractalZoom({ className, style }: FractalZoomProps) {
  ...
  return (
    ...
    >
      ...
      >
        <FractalZoomScene pointerRef={pointerRef} />
      </Canvas>
    </div>
  )
}
