...
interface CellGrowthSceneProps {
  pointerRef: RefObject<PointerState>
}

function CellGrowthScene({ pointerRef }: CellGrowthSceneProps) {
...
export interface CellGrowthProps {
  className?: string
  style?: CSSProperties
}

export function CellGrowth({ className, style }: CellGrowthProps) {
  ...
  return (
    ...
    >
      ...
      >
        <CellGrowthScene pointerRef={pointerRef} />
      </Canvas>
    </div>
  )
}

export default CellGrowth
