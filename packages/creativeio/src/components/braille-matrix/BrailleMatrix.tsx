...
interface BrailleMatrixSimProps {
...
export interface BrailleMatrixProps {
  className?: string
  style?: CSSProperties
  ...
  pressureIterations?: number
  /** Size (in screen pixels) of each 2x4-dot braille cell. */
  cellSize?: number
  /** Dot color. */
  color?: string
}

export function BrailleMatrix({
  className,
  style,
  simResolution = 256,
