...
export interface BlueprintProps {
  ...
  velocityDissipation?: number
  /** How quickly the traced shape fades out each frame (0-1). */
  densityDissipation?: number
...
export function Blueprint({
  ...
  return (
    <div
      ref={containerRef}
      className={className}
      style={{ width: '100%', height: '100%', background: '#0d2961', ...style }}
    >
      <Canvas
        orthographic
