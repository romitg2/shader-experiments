...
export interface ThermalCamProps {
  className?: string
  style?: CSSProperties
  ...
  velocityDissipation?: number
  /** How quickly the heat plume fades out each frame (0-1). */
  densityDissipation?: number
  /** Jacobi iterations for the pressure solve. Higher = more accurate, more expensive. */
  pressureIterations?: number
}

export function ThermalCam({
  className,
  style,
  simResolution = 256,
