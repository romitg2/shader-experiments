...
interface NebulaTurbulenceSceneProps {
  pointerRef: RefObject<PointerState>
}

function NebulaTurbulenceScene({ pointerRef }: NebulaTurbulenceSceneProps) {
...
export interface NebulaTurbulenceProps {
  className?: string
  style?: CSSProperties
}

export function NebulaTurbulence({ className, style }: NebulaTurbulenceProps) {
  ...
  return (
    ...
    >
      ...
      >
        <NebulaTurbulenceScene pointerRef={pointerRef} />
      </Canvas>
    </div>
  )
}

export default NebulaTurbulence
