...
interface CircuitTraceSimProps {
...
export interface CircuitTraceProps {
  ...
  velocityDissipation?: number
  /** How quickly active traces fade out each frame (0-1). */
  densityDissipation?: number
...
const DEFAULT_COLORS = ['#22c55e', '#eab308', '#06b6d4']
...
export function CircuitTrace({
  ...
  return (
    <div
      ref={containerRef}
      className={className}
      style={{ width: '100%', height: '100%', background: '#04120a', ...style }}
    >
      <Canvas
        orthographic
